...
vim.keymap.set("i", "<C-a>S", "<Plug>(nvim-surround-insert-line)",
...
vim.keymap.set("n", "<C-a>ss", "<Plug>(nvim-surround-normal-cur)",
    { desc = "Add a surrounding pair around current line" })
vim.keymap.set("n", "<C-a>S", "<Plug>(nvim-surround-normal-line)",
    { desc = "Add a surrounding pair around a motion (line)" })
vim.keymap.set("n", "<C-a>SS", "<Plug>(nvim-surround-normal-cur-line)",
...
-- Visual mode
vim.keymap.set("x", "<C-a>s", "<Plug>(nvim-surround-visual)",
    { desc = "Add a surrounding pair around a visual selection" })
vim.keymap.set("x", "<C-a>S", "<Plug>(nvim-surround-visual-line)",
